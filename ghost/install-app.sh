...
helm install azure/open-service-broker-azure --name osba --namespace osba --set azure.subscriptionId=${azsubcription},azure.tenantId=${aztenant},azure.clientId=${azprincipal},set azure.clientSecret=${azsecret}
